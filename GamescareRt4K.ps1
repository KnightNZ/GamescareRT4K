...
Function Switch-Input {
    ...
    Write-Host "Changing Input to: ""$URL"""
    SendRt4k -Commands $Command
...
Function Select-Input {
  ...
  #  $form.Controls.Add($GCbuttonR) - Don't add, behaves strangely.
    ...
    # Show the form
    Switch-Input -URL "http://$GamesCareIP/ports" -Command "ok"
    $form.Add_Shown
...
$Script:GamesCareIP = (Test-Connection gcswitch.local -Count 1 -ErrorAction SilentlyContinue).IPV4Address.IPAddressToString
If ($GamesCareIP) 
    {
    ...
    ELSE
    {
        ...
        #$GamesCareIP = "10.0.1.125" # Set IP here if necessary.
     #   Exit 1
    }
